  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      jasmine: {
        jquery: {
          options: {
            vendor: ['public/docsupport/jquery-3.2.1.min.js'],
        ...
        jquery_old: {
          options: {
            vendor: ['public/docsupport/jquery-1.12.4.min.js'],
            specs: 'spec/public/jquery_specs.js'
          },
          src: ['public/chosen.jquery.js']
        },
        proto: {
          options: {
            vendor: ['public/docsupport/prototype-1.7.0.0.js', 'node_modules/simulant/dist/simulant.umd.js'],
    ...
    grunt.registerTask('build', ['coffee:jquery', 'coffee:proto', 'concat', 'uglify', 'postcss', 'cssmin', 'copy']);
    grunt.registerTask('test', ['coffee', 'jasmine']);
    grunt.registerTask('test:jquery', ['coffee:test', 'coffee:jquery', 'jasmine:jquery', 'jasmine:jquery_old']);
    return grunt.registerTask('test:proto', ['coffee:test', 'coffee:proto', 'jasmine:proto']);
  };
